...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-80 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:  
          "bg-[var(--brand-orange)] border border-[var(--brand-orange)] text-black shadow-xs hover:bg-[var(--brand-blue)] hover:text-black focus:bg-[var(--brand-blue)] focus:text-black focus-visible:ring-[var(--brand-blue)/20] focus-visible:ring-offset-1",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "border bg-background text-black shadow-xs hover:bg-[var(--brand-blue)] hover:text-black border-[var(--brand-blue)] dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
